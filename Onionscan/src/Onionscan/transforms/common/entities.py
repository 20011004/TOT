...
__author__ = 'Francesco Poldi'
__copyright__ = 'Copyright 2017, Onionscan Project'
__credits__ = []

__license__ = 'GPLv3'
__version__ = '0.1'
__maintainer__ = 'Francesco Poldi'
__email__ = 'francesco.poldi@protonmail.ch'
...
class MyOnionscanEntity(OnionscanEntity):
